...
function AboutSection() {
    return (
        <section className="px-4 sm:px-20 mt-12 flex flex-col lg:flex-row justify-center items-center gap-5">
            ...
            <div className="w-full lg:w-[calc(50%-0.625rem)]  flex justify-center">
