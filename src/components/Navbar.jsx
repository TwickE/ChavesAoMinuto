        ...
        <header className='w-full fixed z-20 top-0 bg-white border-b border-gray-200 flex justify-center'>
            <nav className="p-4 flex justify-between items-center w-full max-w-[1440px]">
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    <button ref={buttonRef} onClick={() => (setMobileMenuOpen(!mobileMenuOpen))} className='p-2 hover:bg-gray-100 rounded cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-200 md:hidden' aria-label="Abrir Menu de Navegação">
