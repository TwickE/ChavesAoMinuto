...
function ServiceCard({ service }) {
    ...
    return (
        <div className="relative flex-col justify-center bg-gray-50 border-2 border-gray-100 hover:border-primary-default hover:bg-primary-superlight rounded-lg shadow-lg w-72 md:w-80">
